...
- [GoatCounter](/services/goatcounter) - Web analytics platform offering easy to use and meaningful privacy-friendly web analytics.
...
- [Plausible Analytics](/services/plausible) - A lightweight, open-source web analytics tool that prioritizes user privacy by not using cookies.
- [PostHog](/services/posthog) - Open source product analytics.
- [Rybbit](/services/rybbit) - A lightweight, open-source web analytics tool that prioritizes user privacy by not using cookies.
...
- [Databasus](/services/databasus) - A free, open source and self-hosted tool to backup PostgreSQL, MySQL and MongoDB with multiple storage backends.
...
- [Easyappointments](/services/easyappointments) - Open-source appointment scheduler.
...
- [GLPI (Gestionnaire Libre de Parc Informatique)](/services/glpi) - Free, open-source IT Service Management platform for asset management, helpdesk, and service desk operations.
...
- [Once Campfire](/services/once-campfire) - Web-based chat application.
...
- [PG Back Web](/services/pgbackweb) - Effortless PostgreSQL backups with a user-friendly web interface.
...
- [Denokv](/services/denokv) - Deno's built-in key-value database service.
...
- [Jupyter Notebook Python](/services/jupyter-notebook-python) - Interactive computing environment for Python.
...
- [NocoBase](/services/nocobase) - The most extensible AI-powered no-code platform with total control and infinite extensibility.
...
- [OpnForm](/services/opnform) - Open-source form builder that lets you create beautiful forms and share them anywhere.
- [pgAdmin](/services/pgadmin) - A web-based database management tool for administering your PostgreSQL databases through a user-friendly interface.
...
- [Redis Insight](/services/redis-insight) - Official Redis GUI that lets you do both GUI- and CLI-based interactions in a fully-featured desktop GUI client.
- [Rivet Engine](/services/rivet-engine) - Backend engine for running stateful actors at scale with automatic scaling and distributed state management.
...
- [Sonatype Nexus](/services/nexus) - A repository manager that allows you to store, manage, and distribute your software artifacts.
...
- [Vvveb](/services/vvveb) - Powerful website builder with drag and drop functionality.
...
- [Wikijs](/services/wikijs) - Modern and powerful wiki software built on Node.js.
...
- [Usesend](/services/usesend) - Open-source email recall service.
...
- [Pydio Cells](/services/pydio-cells) - File sharing platform for organizations.
...
- [Pterodactyl Panel](/services/pterodactyl) - Game server management panel with Wings daemon for hosting Minecraft, CS:GO, ARK and more.
...
- [BabyBuddy](/services/babybuddy) - It helps parents track their baby's daily activities, growth, and health with ease.
- [SparkyFitness](/services/sparkyfitness) - A comprehensive fitness app that helps users track nutrition, exercise, and body metrics.
...
- [Cap](/services/cap) - Cap is the open source alternative to Loom. Lightweight, powerful, and cross-platform. Record and share in seconds.
...
- [Grimmory](/services/grimmory) - A self-hosted ebook library manager and reader, successor to Booklore.
...
- [Librespeed](/services/librespeed) - Deploy Librespeed on Coolify for self-hosted lightweight speed test.
...
- [Alexandrie](/services/alexandrie) - Markdown note-taking app focused on performance, local data, and knowledge graph navigation.
...
- [Calcom](/services/calcom) - Open-source Calendly alternative for scheduling meetings.
- [CodiMD](/services/codimd) - Realtime collaborative markdown notes on all platforms.
- [Ente](/services/ente-photos) - A fully open-source, end-to-end encrypted platform for you to store data in the cloud without needing to trust the service provider.
...
- [Siyuan](/services/siyuan) - A privacy-first, self-hosted, fully open source personal knowledge management software, written in typescript and golang.
